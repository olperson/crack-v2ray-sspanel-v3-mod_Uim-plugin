...
### caddy安装
``` bash
bash <(curl -L -s https://raw.githubusercontent.com/olperson/crack-v2ray-sspanel-v3-mod_Uim-plugin/master/install_caddy.sh) node.com xxx@gmail.com https://fakeurl.com v2ray 10550
```
